...
function updateLuxuryTimer() {
    const targetDate = new Date(2026, 5, 7, 11, 0, 0);
    const now = new Date();
    ...
    btn.addEventListener('click', () => {
        ...
        const translations = {
            ru: { 
                ...
                detcd6: 'Время',
                detcd7: '7 июня 2026 года, 11:00',
                detcd8: 'Двери открыты с 11:00',
                detcd9: 'Дресс-код',
            ...
            uz: { 
                ...
                detcd6: 'Vaqt',
                detcd7: '2026-yil 7-iyun, soat 11:00',
                detcd8: 'Eshiklar 11:00 dan ochiq',
            ...
            uzk: { 
                ...
                detcd6: 'Вақт',
                detcd7: '2026-йил 7-июнь, соат 11:00',
                detcd8: 'Эшиклар 11:00 дан очиқ',
                detcd9: 'Кийиниш коди',
            ...
            en: { 
                ...
                detcd5: 'Open on map →',
                detcd6: 'Time',
                detcd7: 'June 7, 2026, 11:00',
                detcd8: 'Doors open from 11:00',
                detcd9: 'Dress Code',
...
(function() {
    ...
    const TG_BOT_TOKEN = '8624834285:AAGKm74dZwnlO8_RGHrfgBX8ckTBKK_3Y9Y';
    const TG_CHAT_ID = '6313819055';
    ...
    async function sendToTelegram(data) {
        ...
        const status = statusMap[data.attendance] || data.attendance;
